...
addEventListener("submit", () => {
  document.querySelectorAll(".card-wrapper").forEach(element => element.remove()) //removendo cartas ao clicar no botao nov
...
function settingUpGame(game) {
  ...
  const btnproxTurno = document.getElementById("proxTurno");
