...
addEventListener("submit", function () {
  ...
  var game = new MemoryGame(inputName.value, 5); // startScreen desapareça
  ...
  _createClass(MemoryGame, [{
    ...
    value: function checkPair() {
      ...
      if (this.deck.find(function (element) {
        ...
        this.points--;
        points.innerText = this.points; // desvirar as duas cartas
        ...
        setTimeout(function () {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              document.getElementById(_i).src = _this2.verso; //alterando o alt para carta de verso
