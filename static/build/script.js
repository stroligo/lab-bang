...
var Panic = /*#__PURE__*/function (_CardAction7) {
  _inherits(Panic, _CardAction7);

  var _super10 = _createSuper(Panic);

  function Panic(name, id) {
    _classCallCheck(this, Panic);

    return _super10.call(this, name, id);
  }
...
var Renegado = /*#__PURE__*/function (_CardPlayer2) {
  _inherits(Renegado, _CardPlayer2);

  var _super11 = _createSuper(Renegado);
...
var Stagecoach = /*#__PURE__*/function (_CardAction8) {
  _inherits(Stagecoach, _CardAction8);

  var _super12 = _createSuper(Stagecoach);

  function Stagecoach(name, id) {
    _classCallCheck(this, Stagecoach);

    return _super12.call(this, name, id);
  }
...
var Wellfargo = /*#__PURE__*/function (_CardAction9) {
  _inherits(Wellfargo, _CardAction9);

  var _super13 = _createSuper(Wellfargo);
...
var Whisky = /*#__PURE__*/function (_CardAction10) {
  _inherits(Whisky, _CardAction10);

  var _super14 = _createSuper(Whisky);
...
var Xerife = /*#__PURE__*/function (_CardPlayer3) {
  _inherits(Xerife, _CardPlayer3);

  var _super15 = _createSuper(Xerife);
...
var MemoryGame = /*#__PURE__*/_createClass(function MemoryGame(player, points) {
          ...
          setTimeout(function () {
            ...
            try {
              for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                ...
                document.getElementById(_i2).classList.remove("selecionado", "cardFront"); //alterando o fundo para carta de verso

                document.getElementById(_i2).src = _this2.verso; //alterando o alt para carta de verso
  ...
  var CardPlayer2 = /*#__PURE__*/function (_Card3) {
    ...
    var _super16 = _createSuper(CardPlayer2);
    ...
    function CardPlayer2(name, hp, range, pseudoname, id) {
      ...
      _this3 = _super16.call(this, name, "player", id);
      _this3.hp = hp;
      _this3.range = range;
  ...
  var Xerife2 = /*#__PURE__*/function (_CardPlayer4) {
    _inherits(Xerife2, _CardPlayer4);

    var _super17 = _createSuper(Xerife2);

    function Xerife2(name, hp, range, pseudoname, id) {
      _classCallCheck(this, Xerife2);

      return _super17.call(this, name, hp, range, pseudoname, id);
    }
  ...
  var CardAction2 = /*#__PURE__*/function (_Card4) {
    ...
    var _super18 = _createSuper(CardAction2);

    function CardAction2(name, id) {
      _classCallCheck(this, CardAction2);

      return _super18.call(this, name, "action", id);
    }
  ...
  var Bang2 = /*#__PURE__*/function (_CardAction11) {
    _inherits(Bang2, _CardAction11);

    var _super19 = _createSuper(Bang2);

    function Bang2(name, id) {
      _classCallCheck(this, Bang2);

      return _super19.call(this, name, id);
    }
